...
public final class TaskNamePlanner {
    ...
    public TaskNames taskNames(QuarkusApplicationBuildDescriptor descriptor) {
        ...
        return new TaskNames(
                ...
                prefix + "ImagePush",
                prefix + "AotTraining",
                prefix + "AotEnhancedImageBuild",
                prefix + "AotEnhancedImagePush",
                prefix + "NativeTest");
    }
    ...
    public void validateTaskNameCollisions(Collection<QuarkusApplicationBuildDescriptor> descriptors,
        ...
        for (QuarkusApplicationBuildDescriptor descriptor : descriptors) {
            ...
            validateTaskName(names.aotTraining(), descriptor.name(), seen, existing);
            validateTaskName(names.aotEnhancedImageBuild(), descriptor.name(), seen, existing);
            validateTaskName(names.aotEnhancedImagePush(), descriptor.name(), seen, existing);
