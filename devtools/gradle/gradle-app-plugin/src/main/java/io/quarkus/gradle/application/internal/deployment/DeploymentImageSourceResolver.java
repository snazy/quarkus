...
public final class DeploymentImageSourceResolver {
    ...
    public DeploymentImageSourceResolution resolve(
        ...
        return switch (request.imageSource()) {
            ...
            case AOT_ENHANCED_IMAGE_PUSH -> receiptImage(request, request.aotImagePushReceipt()
                    .orElseThrow(() -> new GradleException("AOT-enhanced image-push deployment requires an image receipt")));
        };
    }
