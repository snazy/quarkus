...
public final class GradleDevOutputChangeMapper {
    ...
    public static BuildOutputChanges toBuildOutputChanges(GradleDevBuildResult result) {
        ...
        return new BuildOutputChanges(result.sequence(), result.status(), mainClassChanges, mainResourceChanges,
                null, null, result.failureSummary(), result.diagnosticsPath(), result.userInitiated(),
                result.forceRestart());
    }
