...
public class ExternalModuleDeclaredDependencyInput
    ...
    static ExternalModuleDeclaredDependencyInput from(
        ...
        return new ExternalModuleDeclaredDependencyInput(
                DependencyDataCollector.resolveArtifactKey(artifact, moduleId),
    ...
    public String getArtifactClassifier() {
        return DependencyDataCollector.defaultIfNull(artifactKey.getClassifier(), "");
    }

    @Input
    public String getArtifactType() {
        return DependencyDataCollector.defaultIfNull(artifactKey.getType(), "");
    }
